...
### This is based on the publication by Darke et al. (2022; 10.1093/jamia/ocab260)
### The above paper presents an algorithm to infer periods of continuous GP 
### ascertainment (i.e., which periods without medical records can be assumed
### to be without medical records because no clinical events occurred versus 
### which periods are "truly" missing). The original code can be found here: 
### https://github.com/philipdarke/ukbb-ehr-data; 'data_period.csv' is the 
### output of that pipeline - the data frame indicates for each participant 
### the periods of continuous EHR ascertainment the code below calculates 
### for each participant the number of days with continuous GP data ascertainment 


# TODO: remove paths; add description (https://github.com/philipdarke/ukbb-ehr-data)
