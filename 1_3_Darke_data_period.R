...
# Load data
data_period <- readRDS('output_files/data_period_raw.rds')
all_records <- readRDS('output_files/all_records.rds')
...
saveRDS(data_period, 'output_files/data_period_raw.rds')
...
write.csv(data_period, 'output_files/data_period.csv')
rm(list = ls())
gc()